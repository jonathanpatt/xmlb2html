...
head = [u'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"\n'
         ...
         '</title>\n<style type="text/css" media="screen">'
            ...
            'div.inter_quote{font-size:.8em;text-align:justify;}'
            'div.quote,div.quote_verse{margin-top:1em;margin-bottom:1em}'
            'div.quote p, div.quote_verse p{padding-left:1.25em;padding-right:1.25em}'
